...
static void STHostResolveCallback(CFHostRef theHost, CFHostInfoType typeInfo, const CFStreamError *error, void *info) {
    ...
    NSLogger(@"STHostResolveCallback:%@, %d, %d, %@", theHost, typeInfo , (int)error->error, info);
    STSimplePing *    obj;
...
-(void)test{
    ...
    host = (CFHostRef) CFAutorelease(CFHostCreateWithName(NULL, (__bridge CFStringRef)@"www.baidu.com"));
